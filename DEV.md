...
Our client will always run on `https://18.61.27.179:8080`. So if it does not automatically open your browser you can go to that URL. It will connect to the URL put in the `.env` file, defaulting to `https://18.61.27.179:5000`.
