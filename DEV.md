...
Our client will always run on `https://ec2-18-61-78-186.ap-south-2.compute.amazonaws.com:8080`. So if it does not automatically open your browser you can go to that URL. It will connect to the URL put in the `.env` file, defaulting to `https://ec2-18-61-78-186.ap-south-2.compute.amazonaws.com:5000`.
